"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\souha\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.470\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '205e4db39bad312448d0b7BFQaVEwCCVgCAQUABwACD10CVlQE', mode: 'runtime'}); } catch(cjsError) { try { import('file:///c:/Users/souha/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '205e4db39bad312448d0b7BFQaVEwCCVgCAQUABwACD10CVlQE', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
